1883 import { useState, useEffect, useRef } from "react";
    ...
    <div className="min-h-screen gradient-navy pb-24">
      ...
      {modal === "add" && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-md glass-card rounded-3xl p-6 border border-primary/15 animate-scale-in max-h-[85vh] overflow-y-auto">
